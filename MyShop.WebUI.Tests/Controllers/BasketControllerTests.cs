...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "andrea.giannelli78@gmail.com", ZipCode = "asdasd" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("andreagiannelli78@gmail.com", "Forms"), null);
